           ...
           VStack(alignment: .leading) {
               ScrollView {
                ...
                //fill with string from the enum into an array so easier to list. However I will need to assign id.
                    FieldView(fieldname:"Age",fieldvalue: profile.agePref.rawValue)
                    FieldView(fieldname:"Gender",fieldvalue: profile.genderPref.rawValue)
                    FieldView(fieldname:"Education",fieldvalue: "High School +")
