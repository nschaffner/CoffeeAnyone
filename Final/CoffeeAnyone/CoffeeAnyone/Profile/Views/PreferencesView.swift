       ...
       var body: some View {
           VStack(alignment: .leading) {
               ScrollView {
                ...
                FieldView(fieldname:"Age",fieldvalue: UserDefaults.standard.string(forKey: "agePref") ?? " ")
                FieldView(fieldname:"Gender",fieldvalue: UserDefaults.standard.string(forKey: "genderPref") ?? " ")
                FieldView(fieldname:"Education",fieldvalue: UserDefaults.standard.string(forKey: "educationPref") ?? " ")
                FieldView(fieldname:"Body Type",fieldvalue:UserDefaults.standard.string(forKey: "bodytypePref") ?? " ")
