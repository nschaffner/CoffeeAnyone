...
final class ProfileBody: ObservableObject, Codable {
      ...
      var occupation: String = UserDefaults.standard.string(forKey: "job") ?? ""
      ...
      var hobbies1: String = UserDefaults.standard.string(forKey: "hobbie1") ?? ""
      var hobbies2: String = UserDefaults.standard.string(forKey: "hobbie2") ?? ""
      var hobbies3: String = UserDefaults.standard.string(forKey: "hobbie3") ?? ""
      var hobbies4: String = UserDefaults.standard.string(forKey: "hobbie4") ?? ""
      var hobbies5: String = UserDefaults.standard.string(forKey: "hobbie5") ?? ""
