...
final class LoveLangQuiz: ObservableObject, Identifiable {
    private var index = 0
    ...
    func calculatelovelanguage() -> String {
        ...
        UserDefaults.standard.set(self.WA, forKey: "WA")

        UserDefaults.standard.set(self.QT, forKey: "QT")
 
        UserDefaults.standard.set(self.RG, forKey: "RG")
 
        UserDefaults.standard.set(self.AS, forKey: "AS")

        UserDefaults.standard.set(self.PT, forKey: "PT")
